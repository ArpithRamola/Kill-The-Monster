...
function setup() {
  ...
  block24= new Block(600,430,40,40);
  block25 = new Block(600,410,40,40);
  block26 = new Block(600,390,40,40);
  block27 = new Block(600,370,40,40);
  block28 = new Block(600,350,40,40);
  block29 = new Block(600,330,40,40);

  block30 = new Block(650,430,40,40);
  block31 = new Block(650,410,40,40);
  block32 = new Block(650,390,40,40);
  block33 = new Block(650,370,40,40);
  block34 = new Block(650,350,40,40);
  block35 = new Block(650,330,40,40);
  block36 = new Block(650,310,40,40);
